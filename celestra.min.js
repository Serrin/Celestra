/** Celestra * @version 1.15.3 * @see https://github.com/Serrin/Celestra/ */
"use strict";
/* polyfills */
...
function getUrlVar(n){var r={};var w=window.location.search.substring(1).split("&");for(var i=0,l=w.length;i<l;i++){var e=w[i].split("=");r[e[0]]=decodeURIComponent(e[1]);}if(n){return r[n]?r[n]:undefined;}else{return r;}}
