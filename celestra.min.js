/** Celestra * @version 2.9.0 * @see https://github.com/Serrin/Celestra/ * @license MIT */
...
function isIterator(v){return celestra.__objType__(v).includes("iterator");}
...
function isArrayBuffer(v){return (celestra.__objType__(v)==="arraybuffer");}
