/** Celestra * @version 2.0.4 * @see https://github.com/Serrin/Celestra/ * @license MIT */
...
function domCreate(t,ps,iH){var el=document.createElement(t);if(ps){for(var p in ps){if(p!=="style"){el[p]=ps[p];}else{for(var s in ps[p]){el.style[s]=ps[p][s];}}}}if(iH){el.innerHTML=iH;}return el;}
