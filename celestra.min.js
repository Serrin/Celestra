/** Celestra * @version 1.20.2 * @see https://github.com/Serrin/Celestra/ * @license MIT */
(function(window,document){
"use strict";
var Celestra={};
Celestra.version="Celestra v1.20.2";
Celestra.noConflict=function(){window._=Celestra._prevUnderscore;return Celestra;};
...
if(typeof window!=="undefined"){window.Celestra=Celestra;Celestra._prevUnderscore=window._;window._=Celestra;}
}(window,document));