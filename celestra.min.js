/** Celestra * @version 4.2.0 min * @see https://github.com/Serrin/Celestra/ * @license MIT */
...
function isSameArray(a,b){if(Array.isArray(a)&&Array.isArray(b)&&a.length===b.length){for(var i=0,l=a.length;i<l;i++){if(a[i]!==b[i]){return false;}}return true;}return false;}const isString=(v)=>(typeof v==="string");
...
const VERSION="Celestra v4.2.0 min";
