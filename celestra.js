...
Celestra.version = "Celestra v1.17.0";
...
Celestra.getUrlVar = function getUrlVar(n){var r={},w=window.location.search.substring(1).split("&");for(var i=0,l=w.length;i<l;i++){var e=w[i].split("=");r[e[0]]=decodeURIComponent(e[1]);}if(n){return r[n]?r[n]:undefined;}else{return r;}}
Celestra.getUrlVarFromString = function getUrlVarFromString(qstr,n){var r={},w=qstr.substring(1).split("&");for(var i=0,l=w.length;i<l;i++){var e=w[i].split("=");r[e[0]]=decodeURIComponent(e[1]);}if(n){return r[n]?r[n]:undefined;}else{return r;}}
