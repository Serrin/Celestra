"use strict";
/** Celestra * @version 4.2.0 esm * @see https://github.com/Serrin/Celestra/ * @license MIT */
...
if (!("at" in String.prototype)){Object.defineProperty(String.prototype,"at",{writable:true,enumerable:false,configurable:true,value:function at(n){n=Math.trunc(n)||0;if(n<0){n+=this.length;}if(n<0||n>=this.length){return undefined;}return String(this)[n];}});}
