"use strict";
/** Celestra * @version 3.2.0 * @see https://github.com/Serrin/Celestra/ * @license MIT */
...
function removeCookie(name,path="/",domain,secure,HttpOnly){var r=(document.cookie.includes(encodeURIComponent(name)+"="));document.cookie=encodeURIComponent(name)+"=; expires=Thu, 01 Jan 1970 00:00:01 GMT"+"; path="+path+(domain?"; domain="+domain:"")+(secure?"; secure":"")+(HttpOnly?"; HttpOnly":"")+";";return r;}
