"use strict";
/** Celestra * @version 5.3.2 esm * @see https://github.com/Serrin/Celestra/ * @license MIT */
...
const isIterator=(v)=>(Object.prototype.toString.call(v).slice(8,-1).toLowerCase().includes("iterator")||typeof v.next==="function");
...
function arrayMerge(flat,...a){if(typeof flat==="boolean"){var t=a[0];a=a.slice(1);}else{var t=flat;flat=false;}t.push(...[].concat(...(flat?a.flat(Infinity):a)));return t;}
