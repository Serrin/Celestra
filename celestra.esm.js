"use strict";
/** Celestra * @version 4.1.0 esm * @see https://github.com/Serrin/Celestra/ * @license MIT */
...
function assert(c,m=""){if(!c){throw new Error("[assert] "+m);}return true;}
function assertLog(c,m=""){if(!c){console.log("[assertLog] "+m);}return true;}
function assertAlert(c,m=""){if(!c){alert("[assertAlert] "+m);}return true;}
