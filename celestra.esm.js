"use strict";
/** Celestra * @version 4.3.0 esm * @see https://github.com/Serrin/Celestra/ * @license MIT */
...
function assertEq(msg,v1,v2,strict=true){if(strict?v1!==v2:v1!=v2){throw new Error("[assertEq] - "+v1+" - "+v2+" - "+msg);}return true;}
function assertNotEq(msg,v1,v2,strict=true){if(strict?v1===v2:v1==v2){throw new Error("[assertNotEq] - "+v1+" - "+v2+" - "+msg); }return true;}
...
function*enumerate(it){let i=0;for(let item of it){yield [i++, item];}}
