"use strict";
/** Celestra * @version 3.1.1 * @see https://github.com/Serrin/Celestra/ * @license MIT */
...
const isIterator=(v)=>(celestra.__objType__(v).includes("iterator")||(typeof v.next==="function"));
