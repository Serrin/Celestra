"use strict";
/** Celestra * @version 5.4.1 esm * @see https://github.com/Serrin/Celestra/ * @license MIT */
...
if(!("groupBy" in Array.prototype)){Object.defineProperty(Array.prototype,"groupBy",{"configurable":true,"writable":true,"enumerable":false,"value":function(fn,thisArg){"use strict";function toArray(O){return (Array.isArray(O)?O:Array.from(O));}if(!(typeof fn==="function")){throw new TypeError();}var a=toArray(this);var key,r=Object.create(null),l=a.length;for(var i=0;i<l;i++){key=fn.call(thisArg,a[i],i,a);if(!(Object.prototype.hasOwnProperty.call(r,key))){r[key]=[];}r[key].push(a[i]);}return r;}});}
if(!("groupByToMap" in Array.prototype)){Object.defineProperty(Array.prototype,"groupByToMap",{"configurable":true,"writable":true,"enumerable":false,"value":function(fn,thisArg){"use strict";function toArray(O){return (Array.isArray(O)?O:Array.from(O));}if(!(typeof fn==="function")){throw new TypeError();}var a=toArray(this);var key,r=new Map(),l=a.length;for(var i=0;i<l;i++){key=fn.call(thisArg,a[i],i,a);if(!(r.has(key))){r.set(key,[]);}r.get(key).push(a[i]);}return r;}});}
...
const VERSION="Celestra v5.4.1 esm";
