"use strict";
/** Celestra * @version 3.1.2 * @see https://github.com/Serrin/Celestra/ * @license MIT */
...
const isEqual=(a,b)=>(celestra.getType(a,celestra.getType(b))&&JSON.stringify(a)===JSON.stringify(b));
...
function setCookie(name,value,hours=8760,path="/",domain,secure,HttpOnly){var expire=new Date();expire.setTime(expire.getTime()+(Math.round(hours*60*60*1000)));document.cookie=encodeURIComponent(name)+"="+encodeURIComponent(value)+"; expires="+expire.toUTCString()+"; path="+path+(domain?"; domain="+domain:"")+(secure?"; secure":"")+(HttpOnly?"; HttpOnly":"")+";";}
