"use strict";
/** Celestra * @version 5.3.1 esm * @see https://github.com/Serrin/Celestra/ * @license MIT */
...
function extend(...args){function innerExtend(){var so={};if(typeof arguments[0]==="boolean"){var t=arguments[1],d=arguments[0],s=2;}else{var t=arguments[0],d=false,s=1;}for(var i=s,l=arguments.length;i<l;i++){so=arguments[i];if(so!=null){for(var a in so){if(Object.hasOwn(so,a)){if(typeof so[a]==="object"&&d){t[a]=innerExtend(true,{},so[a]);}else{t[a]=so[a];}}}}}return t;}return innerExtend(...args);}
