...
if(_cut.isNotIE11()) {
   try {
    _cut.isEqual("arrayUnion() ES6",
      "[1,2,3,4,5,6,7,8]",
      JSON.stringify(_.arrayUnion(new Set(a),b.values(),new Set(c).values()))
    );
    _cut.isEqual("arrayIntersection() ES6",
      "[3,4]", JSON.stringify(_.arrayIntersection(a.values(),new Set(b)))
    );
    _cut.isEqual("arrayDifference() ES6",
      "[1,2]", JSON.stringify(
        _.arrayDifference(new Map([[1,2],[2,3],[3,4],[4,5]]).keys(),b.values())
      )
    );
    _cut.isEqual("arraySymmetricDifference() ES6",
      "[1,2,5,6]", JSON.stringify(_.arraySymmetricDifference(
...
_cut.isEqual(
  "uniquePush() value check", "[1,2,3,5,4]", JSON.stringify(uniquePushTest)
);
...
_cut.isTrue("hasCookie() true", _.hasCookie("ctest3") );
...
_cut.isTrue("<b>ES6 -</b> isSymbol() true", _.isSymbol( Symbol("str") ) );
_cut.isFalse("<b>ES6 -</b> isSymbol() false", _.isSymbol(_.noop) );
_cut.isTrue("<b>ES6 -</b> isMap() true", _.isMap( new Map() ) );
_cut.isFalse("<b>ES6 -</b> isMap() false", _.isMap(_.noop) );
_cut.isTrue("<b>ES6 -</b> isSet() true", _.isSet( new Set() ) );
_cut.isFalse("<b>ES6 -</b> isSet() false", _.isSet(_.noop) );
_cut.isTrue("<b>ES6 -</b> isWeakMap() true", _.isWeakMap( new WeakMap() ) );
_cut.isFalse("<b>ES6 -</b> isWeakMap() false", _.isWeakMap(_.noop) );
_cut.isTrue("<b>ES6 -</b> isWeakSet() true", _.isWeakSet( new WeakSet() ) );
_cut.isFalse("<b>ES6 -</b> isWeakSet() false", _.isWeakSet(_.noop) );
_cut.isTrue("<b>ES6 -</b> isIterator() true - Array values()",
  _.isIterator([4,5,6].values())
);
_cut.isTrue("<b>ES6 -</b> isIterator() true - Set values()",
  _.isIterator(new Set([4,5,7]).values())
);
_cut.isTrue("<b>ES6 -</b> isIterator() true - Map values()",
  _.isIterator(new Map([[4,5],[5,6]]).values())
);
if (_cut.isNotEdge()) {
  _cut.isTrue("<b>ES6 -</b> isIterator() true - Nodelist values()",
    _.isIterator(document.querySelectorAll("h3").values())
  );
}
_cut.isFalse("<b>ES6 -</b> isIterator() false - Array", _.isIterator([4,5,7]));
_cut.isTrue("<b>ES6 -</b> isIterable() true",
  _.isIterable([]) && _.isIterable("")
    && _.isIterable(new Map([[1,2],[3,4]])) && _.isIterable(new Set([1,2]))
);
_cut.isFalse("<b>ES6 -</b> isIterable() false",
  _.isIterable(42) || _.isIterable(3.14) || _.isIterable({a:1,b:2})
    || _.isIterable(true) || _.isIterable(false)
);
if (!!window.BigInt) {
  _cut.isTrue("<b>ES6 -</b> isBigInt() true",
