/** Celestra FP * @version 1.18.1 * @see https://github.com/Serrin/Celestra/ */
"use strict";
/* polyfills */
...
function removeCookie(name,path,domain,secure,HttpOnly){if(document.cookie.indexOf(encodeURIComponent(name)+"=")!==-1){document.cookie=encodeURIComponent(name)+"="+"; expires=Thu, 01 Jan 1970 00:00:01 GMT"+(path?"; path="+path:"")+(domain?"; domain="+domain:"")+(secure?"; secure":"")+(HttpOnly?"; HttpOnly":"")+";";return true;}return false;}